...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateArtwork() {
        ...
        when (currentIndex) {
            0 -> artworkImage.setImageResource(R.drawable.monalisa)
            1 -> artworkImage.setImageResource(R.drawable.starrynight)
            2 -> artworkImage.setImageResource(R.drawable.thescream)
        }
    }
